...
/**
 * Diese Klasse repraesentiert genau einen Punkt. Dieser wird mit Hoehe, Breite und seinen (x,y)-Koordinaten angegeben.
...
public class Punkt {
	...
	public boolean intersects(Punkt k) {
